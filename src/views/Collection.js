...
export default function Collection() {
  const items =[
    {
      id: 1,
      title: 'Simay ve ErenYalcn',
      artist: 'ErenYalcn ile simay için derleme',
  ...
  return (
    <div>
            <h3 className='text-2xl text-white font-bold tracking-tight mb-4'>Çalma Listeleri</h3>
        ...
        <div className='grid grid-cols-2 gap-x-4'>
          <div className='h-[296px] bg-gradient-to-r from-gra3 to-gra4 rounded p-6 group relative'>
            <div className='mt-20'>
              ...
              <span className='text-sm font-semibold'>Emir Can İğrek</span> <span className='opacity-70'> • Yangınlı Şiir </span>
              <span className='text-sm font-semibold'>Emir Can İğrek</span> <span className='opacity-70'> • Nevale </span>
              <span className='text-sm font-semibold'>Emir Can İğrek</span> <span className='opacity-70'> • Nevale </span>
              <span className='text-sm font-semibold'>Emir Can İğrek</span> <span className='opacity-70'> • Nevale </span>  
            </div>
